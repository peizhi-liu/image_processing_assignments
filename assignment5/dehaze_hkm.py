...
im = deHaze(cv2.imread("F:/PythonProject/image_processing/dehaze_hekaiming/scenery.jpg") / 255.0) * 255

cv2.imwrite("F:/PythonProject/image_processing/dehaze_hekaiming/scenery_dehaze.png", im)
